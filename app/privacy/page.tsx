	...
	return (
		<main className='mx-auto max-w-md px-4 py-6 text-sm text-foreground'>
			...
			<section className='mb-6'>
				<p>
					Сайт{' '}
					<a href='https://barberstate51.ru' className='text-red-600 underline'>
						barberstate51.ru
					</a>{' '}
			...
			<section className='mb-6'>
				...
				<p>
					...
					онлайн записи на прием. Переход по ним осуществляется только по
					инициативе пользователя. Персональные данные при этом обрабатываются
			...
			<section className='mb-6'>
				...
				<p>
					...
					<a
						href='mailto:info@barberstate51.ru'
						className='text-red-600 underline'
					>
						info@barberstate51.ru
					</a>
				</p>
			</section>
